.orgchart-container{
  position:relative;display:inline-block;height:420px;
  width:calc(100% - 24px);
  text-align:center
}
.orgchart{-webkit-box-sizing:border-box;box-sizing:border-box;display:inline-block;min-height:202px;
  min-width:202px;-webkit-touch-callout:none;
...
.orgchart .lines .rightLine{border-right:1px solid #20b2aa;float:none;border-radius:0}.orgchart .lines .leftLine{border-left:1px solid #20b2aa;float:none;border-radius:0}.orgchart .lines .downLine{background-color:#20b2aa;margin:0 auto;height:20px;width:2px;float:none}
.orgchart .node{
  -webkit-box-sizing:border-box;
  box-sizing:border-box;
  ...
  padding-bottom: 0px;
  padding-left: 3px;
  border:2px dashed transparent;text-align:center;
  width:200px
}

.orgchart.l2r .node,.orgchart.r2l .node{width:50px;height:130px}

.orgchart .node>.spinner{position:absolute;top:calc(50% - 15px);left:calc(50% - 15px);vertical-align:middle;font-size:30px;color:rgba(68,157,68,.8)}.orgchart .node:hover{-webkit-transition:.5s;transition:.5s;cursor:default;z-index:20}.orgchart .node.focused,.orgchart .node:hover{background-color:rgba(238,217,54,.5)}.orgchart .ghost-node{position:fixed;left:-10000px;top:-10000px}.orgchart .ghost-node rect{fill:#fff;stroke:#bf0000}.orgchart .node.allowedDrop{border-color:rgba(68,157,68,.9)}
